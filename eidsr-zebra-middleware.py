...
DB_FILE = os.path.join(DATA_DIR, "middleware.db")
eConfig = os.path.join(CONFIG_DIR, "eIDSR_auth.json")
zConfig = os.path.join(CONFIG_DIR, "zebra_auth.json")
